...
function DashboardLearnerNavbar({activeTab, onChange}) {
    // Today's Date
            ...
            <div>
                ...
                <div className="LowerLinks flex justify-start">
                    ...
                    <div className="mr-3 mt-2">
                        ...
                        <div className={`mr-3 mt-2 -mb-[8px] ${activeTab === 'continuing' ? "text-red-600 bg-gray-200" : ""}`}>
                            <p className={`navbar-lowerlinks px-[4px]`} onClick={() => onChange('continuing')}>Continuing</p>
                    </div>
                   
                        <div className={`mr-3 mt-2 -mb-[8px] ${activeTab === 'completed' ? "text-red-600 bg-gray-200" : ""}`}>
                            <p className={`navbar-lowerlinks px-[4px]`} onClick={() => onChange('completed')}>Completed</p>
                    </div>
                    <div className="mr-3 mt-2">
...
export default DashboardLearnerNavbar