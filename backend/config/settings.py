...
SECRET_KEY = 'django-insecure-h0n#w2&(^-29^60qvuzwje+4f#5t^sq34q36b^_kj30w$yw=u6'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',      #Must be above Commonmidleware
...
# Handling the uploaded media files
MEDIA_URL = '/media/'
